<?php
// GET    /api/destinations.php          → list
// POST   /api/destinations.php          → create
// GET    /api/destinations.php?id=5     → show
// PUT    /api/destinations.php?id=5     → update
// DELETE /api/destinations.php?id=5     → delete
