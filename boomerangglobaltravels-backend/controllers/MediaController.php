...
class MediaController
{
     ...
     * We expose it as "/boomerangglobaltravels-backend/uploads/packages/file.jpg" so the frontend
    ...
    private function relativeUrl(string $filePath): string
    {
        ...
        return '/boomerangglobaltravels-backend/' . $filePath;
    }
    ...
    public function destroy(int $id): void
    {
        ...
        // Strip leading "boomerangglobaltravels-backend/" or "backend/" if somehow stored that way
        $cleanPath = preg_replace('#^(boomerangglobaltravels-backend|backend)/#', '', $cleanPath);
