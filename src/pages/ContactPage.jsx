    ...
    <div className="min-h-screen bg-stone-50 pt-16">
      ...
      <div className="bg-gradient-to-br from-teal-700 via-teal-800 to-teal-950 py-16 px-4 text-center text-white">
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
          ...
          <p className="text-teal-200 mt-3 max-w-xl mx-auto">Send us an inquiry and our travel experts will craft a personalized itinerary just for you — within 24 hours.</p>
        </motion.div>
      </div>
          ...
          <div className="space-y-5">
            ...
            {contactInfo.map((c, i) => (
              <motion.a key={i} href={c.href} initial={{ opacity: 0, x: -20 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ delay: i * 0.1 }}
                className="flex items-start gap-4 bg-white rounded-2xl p-5 shadow-sm border border-gray-100 hover:shadow-md hover:border-amber-200 transition-all group">
              ...
              {submitted ? (
                ...
                <>
                  ...
                  <form onSubmit={handleSubmit} className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                    ...
                    <div>
                      <label className="text-xs font-semibold text-gray-500 block mb-1.5">Number of Travellers</label>
                    ...
                    <div className="sm:col-span-2">
                      <button type="submit" className="w-full flex items-center justify-center gap-2 bg-gradient-to-r from-teal-600 to-teal-700 hover:from-teal-700 hover:to-teal-800 text-white font-bold py-4 rounded-2xl transition-all shadow-lg text-base">
