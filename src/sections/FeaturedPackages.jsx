          ...
          {featured.map((pkg, i) => (
            ...
            >
              <div className="relative lg:w-2/5 h-64 lg:h-auto overflow-hidden">
                ...
                {pkg.tag && (
                  <span className="absolute top-5 left-5 bg-amber-500 text-white text-xs font-bold px-3 py-1.5 rounded-full">
                    {pkg.tag}
                  </span>
                )}
              </div>
              ...
              <div className="flex-1 p-6 lg:p-8 flex flex-col justify-between">
                <div className="space-y-4">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {pkg.highlights.slice(0, 4).map((h) => (
                      <span key={h} className="text-xs bg-teal-50 text-teal-700 px-3 py-1.5 rounded-full font-medium">
                        ✓ {h}
                      </span>
                    ))}
                  </div>
                ...
                <div className="flex items-center justify-between mt-6 pt-5 border-t border-gray-100">
                  ...
                  <div className="flex gap-3">
                    <Link to="/contact" className="border-2 border-teal-600 text-teal-700 hover:bg-teal-50 font-semibold text-sm px-5 py-2.5 rounded-2xl transition-colors">
                      Inquire
                    </Link>
